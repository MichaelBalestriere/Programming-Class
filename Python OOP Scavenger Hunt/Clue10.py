...
class Salesperson(Manager):
    ...
    def farm_beets(self):
        print("Selling paper instead of farming beets.")  # Overridden method
...
salesperson1.farm_beets()  # Calls the overridden farm_beets method in Salesperson

manager_str = "Michael Scott-Sales-Jim-Dwight-Pam"
new_manager = Manager.from_string(manager_str)
print(new_manager.get_info())

print("Full name of the manager:", manager1.full_name)

print(Manager.is_valid_department("Sales"))
print(Manager.is_valid_department("Marketing"))
