...
Class Methods (methods belonging to the class) are 
methods that are not bound to an instance of the class. 
They are bound to the class itself. They can be called 
on the class or on an instance of the class. They are 
